...
section .bss    
    buffer resb 50
    number1 resb 4 ; 10 <= number1 <= 30
    number2 resb 4 ; 10 <= number2 <= 30
...
; nasm -f elf32 0008_GCD.asm && gcc -no-pie 0008_GCD.o -o 0008_GCD    

; debug version
; nasm -f elf32 -g -F dwarf 0008_GCD.asm && gcc -fno-builtin -no-pie 0008_GCD.o -o 0008_GCD
; gdb 0008_GCD -tui